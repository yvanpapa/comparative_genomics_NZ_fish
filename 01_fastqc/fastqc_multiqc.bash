...
#SBATCH --time=6-12:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/popgen/02_multiqc/lib7/job_out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/popgen/02_multiqc/lib7/job_err
...
read_dir=/nfs/scratch/papayv/Tarakihi/raw_data/popgen/lib7
output_dir=/nfs/scratch/papayv/Tarakihi/popgen/02_multiqc/lib7/results/
...
echo "mais celà ne nous regarde pas"
